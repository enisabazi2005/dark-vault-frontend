        ...
        <div className="profile-view-container">
          ...
          {search.trim() !== '' && (
            <div className="profile-view-filtered-users-list">
              {isSearching ? (
                ...
                filteredUsers.map((user) => (
                  ...
                  >
                    ...
                    <div className="profile-view-user-info">
                      ...
                      <p className={`profile-view-user-status ${getUserStatus(user)}`}>
                        {getUserStatus(user)}
                      </p>
                    </div>
                  </div>
                ...
                <div className="profile-view-no-results">No users found matching "{search}"</div>
              )}
            </div>
          )}
          ...
          {selectedUser && (
            <div className="profile-view-modal-overlay" onClick={handleCloseModal}>
              <div className="profile-view-modal-content" onClick={(e) => e.stopPropagation()}>
                <img
                  src={selectedUser.picture ? `${STORAGE_URL}/${selectedUser.picture}` : defaultBlankPhotoUrl}
                ...
                <p className={`profile-view-user-status ${getUserStatus(selectedUser)}`}>
                ...
                <button className="profile-view-close-button" onClick={handleCloseModal}>
                  Close
                </button>
              </div>
            </div>
